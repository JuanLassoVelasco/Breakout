...
Texture2D ResourceLoader::LoadTexture(const char *file, bool alpha, std::string name)
{
...
Texture2D ResourceLoader::loadTextureFromFile(const char *file, bool alpha)
{
